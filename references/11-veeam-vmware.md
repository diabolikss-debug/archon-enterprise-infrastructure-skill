...
<!-- SOURCE: 50-VEEAM-DATA-PLATFORM-KNOWLEDGE.md -->

# ARCHON KNOWLEDGE PACK

**DOMAIN:** Veeam Data Platform Knowledge  
**VERSION:** 1.0  
...
# 50 VEEAM DATA PLATFORM KNOWLEDGE

## 1. Purpose

This pack extends ARCHON with structured knowledge for **Veeam Data Platform Knowledge**. It complements the Core Runtime and existing discovery, sizing, evidence, assumption, RFP, BOM and anti-hallucination frameworks.
...
### 1. Map Veeam architecture from RPO/RTO, protected workloads, change rate, retention, immutability, backup window and recovery requirements

Map Veeam architecture from RPO/RTO, protected workloads, change rate, retention, immutability, backup window and recovery requirements.

### 2. Keep backup server, proxies, repositories, object/tape tiers, WAN/copy jobs and monitoring/security roles distinct

Keep backup server, proxies, repositories, object/tape tiers, WAN/copy jobs and monitoring/security roles distinct.

### 3. Veeam ONE, Backup & Replication and other platform components must not be conflated; exact logging/SIEM/capabilities are version-sensitive

Veeam ONE, Backup & Replication and other platform components must not be conflated; exact logging/SIEM/capabilities are version-sensitive.

### 4. Size for restore and Instant Recovery as well as backup ingest

Size for restore and Instant Recovery as well as backup ingest.

### 5. Licensing, supported repositories, hardened-repository behavior and integrations require current Veeam documentation

Licensing, supported repositories, hardened-repository behavior and integrations require current Veeam documentation.
...
<!-- END SOURCE: 50-VEEAM-DATA-PLATFORM-KNOWLEDGE.md -->


---

<!-- SOURCE: 51-VMWARE-INFRASTRUCTURE-KNOWLEDGE.md -->

# ARCHON KNOWLEDGE PACK

**DOMAIN:** VMware Infrastructure Knowledge  
**VERSION:** 1.0  
**LAST REVIEWED:** 2026-09-20  
**VOLATILITY:** HIGH for commercial/version-specific facts; LOW-MEDIUM for architecture principles  
**EVIDENCE CLASS:** ARCHON engineering / product knowledge layer  
...
# 51 VMWARE INFRASTRUCTURE KNOWLEDGE

## 1. Purpose

This pack extends ARCHON with structured knowledge for **VMware Infrastructure Knowledge**. It complements the Core Runtime and existing discovery, sizing, evidence, assumption, RFP, BOM and anti-hallucination frameworks.
...
### 1. Architecture should cover ESXi/vSphere clusters, HA/DRS behavior, storage/network integration, lifecycle, admission capacity and failure-state sizing

Architecture should cover ESXi/vSphere clusters, HA/DRS behavior, storage/network integration, lifecycle, admission capacity and failure-state sizing.

### 2. CPU Ready, Co-Stop, memory pressure, NUMA and largest-VM placement matter more than VM count alone

CPU Ready, Co-Stop, memory pressure, NUMA and largest-VM placement matter more than VM count alone.

### 3. Licensing is highly volatile; never rely on historical licensing rules without current evidence

Licensing is highly volatile; never rely on historical licensing rules without current evidence.

### 4. Validate HCL for server, CPU, HBA/NIC, storage, firmware/driver and exact vSphere release

Validate HCL for server, CPU, HBA/NIC, storage, firmware/driver and exact vSphere release.

### 5. Keep VMware technical architecture separate from commercial assumptions

Keep VMware technical architecture separate from commercial assumptions.
...
<!-- END SOURCE: 51-VMWARE-INFRASTRUCTURE-KNOWLEDGE.md -->
